 ...
 */
public final class VistaTabla extends javax.swing.JFrame {
    ...
    public void  PasarLista(ArrayList<Alumno> listaD){
        for (Alumno alumno : listaD) {
           lista.add(alumno);
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnCrear, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, -1, -1));
        ...
        getContentPane().add(btnGuardaModificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, -1, -1));
    ...
    public void cargarLista()  {
        int numFila = this.jTableAlumno.getRowCount(), numColumna = this.jTableAlumno.getColumnCount();
        for (int i = 0; i < numFila; i++) {
            String acu = "";
            for (int j = 0; j < numColumna; j++) {
                    acu += String.valueOf(this.jTableAlumno.getValueAt(i, j)).trim() + ",";
            }
          String datos[]=acu.split(",");
         lista.add(new Alumno(datos[0],datos[1],datos[2],datos[3]));
        }
    ...
    public javax.swing.JButton btnGuardaModificacion;
    ...
    public javax.swing.JTable jTableAlumno;
